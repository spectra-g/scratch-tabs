    ...
    "categories": [
      ...
      },
      {
        ...
        "changes": [
          ...
          "**Streamlined Curl Builder:** HTTP Method and URL now on a single intuitive line with compact dropdown (no label needed) - users immediately understand the interface, \"Open in Rest Client\" button properly sized to match header buttons, and all tabs/buttons using consistent compact spacing",
          "**Better UX Clarity:** Renamed \"Add Curl\" to \"Add Request\" for clearer action description, \"Curl Request Workbench\" shortened to \"Curl Workbench\", and all buttons/icons sized consistently (14px icons, py-1.5 padding)"
        ]
      },
      {
        "name": "Testing",
        "changes": [
          "**Regex Interpretation Tests:** Added 15 specialized unit tests covering modern syntax, incomplete patterns, and nested AST fidelity - ensuring high-quality explanations even for complex edge cases",
          "**Share Modal Tests:** Added 4 new unit tests covering manual customization workflow, button visibility, trim UI activation, and JSON content support - all 13 ShareModal tests passing",
          "**Curl Smart View Tests:** Updated test expectations for new UI labels and verified all 5,599 tests passing across entire codebase"
        ]
      }
    ]
  },
