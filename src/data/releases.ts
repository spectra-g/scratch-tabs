...
export const RELEASES: Release[] = [
  {
    ...
    "type": "latest",
    "date": "2026-01-29",
    "headline": "Share Customization & Curl UI Polish",
    "summary": "Manual content trimming for privacy-safe sharing, plus compact professional Curl Smart View redesign",
    "categories": [
      {
        "name": "New Features",
        "changes": [
