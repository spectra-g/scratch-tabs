  ...
  switch (dialect) {
      ...
      return {
        ...
        examples: [
          ...
          { expression: "*/15 * * * *", description: "Every 15 minutes" },
          {
            ...
            description: "Every hour from 9 AM to 5 PM, Monday through Friday",
          },
        ],
      };
    ...
    case "quartz":
      return {
        ...
        description:
          "Quartz Scheduler format with 6 or 7 fields, including seconds and optional year.",
        fields: [
          {
            name: "second",
            required: true,
    ...
    case "spring":
      return {
        ...
        description:
          "Spring Scheduler format with 6 fields, including seconds.",
        fields: [
          {
            name: "second",
            required: true,
      ...
      return {
        ...
        fields: [
          ...
          },
          {
            ...
            required: true,
            description: "Day of Week (1-7, 1=Sunday)",
            allowedValues: "1-7, *, /, -, SUN-SAT",
          },
          {
            name: "year",
            required: true,
            description: "Year",
            allowedValues: "*, /, -, 1970-2199",
          },
        ],
        examples: [
          { expression: "0 0 * * ? *", description: "Daily at midnight" },
      ...
      return {
        ...
        fields: [
          ...
          },
          {
            name: "dayOfWeek",
            required: true,
            description: "Day of Week (0-7, 0,7=Sunday)",
            allowedValues: "0-7, *, /, -, SUN-SAT",
          },
        ],
        examples: [
          {
            expression: "H H * * *",
            description: "Once a day (with H for load balancing)",
          },
          {
            expression: "H/15 * * * *",
            description: "Every 15 minutes (with H for load balancing)",
          },
          {
            expression: "H 9-17 * * 1-5",
            description:
              "Once an hour from 9 AM to 5 PM, Monday through Friday",
          },
        ],
      };
