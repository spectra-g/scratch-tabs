        ...
        savedPatterns: [
          {
            ...
            expression: "* * * * *",
            dialect: "unix",
            description: "Runs every minute of every hour, every day",
          },
          {
            id: "2",
            name: "Hourly",
            expression: "0 * * * *",
            dialect: "unix",
            description: "Runs at the start of every hour, every day",
          },
          {
            id: "3",
            ...
            expression: "0 0 * * *",
            dialect: "unix",
            description: "Runs at midnight (00:00) every day",
          },
          {
            id: "4",
