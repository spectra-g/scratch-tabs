...
export const PomodoroTimer: React.FC<PomodoroTimerProps> = ({
  ...
  }, [currentSession.timeRemaining, currentSession.duration, currentSession.type, status]);
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative">
        <canvas ref={canvasRef} width="300" height="300" className="mb-4"></canvas>
      ...
      <div className="text-xs text-gray-500 mt-4">
        Press <kbd className="px-1.5 py-0.5 bg-gray-800 rounded text-gray-300">Space</kbd> to start/pause, 
        <kbd className="px-1.5 py-0.5 bg-gray-800 rounded text-gray-300 ml-1">R</kbd> to reset, 
        <kbd className="px-1.5 py-0.5 bg-gray-800 rounded text-gray-300 ml-1">S</kbd> to skip
      </div>
    </div>
  );
};