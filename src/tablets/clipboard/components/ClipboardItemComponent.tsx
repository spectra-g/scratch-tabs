...
export const ClipboardItemComponent: React.FC<ClipboardItemComponentProps> = ({
  ...
  if (viewMode === "card") {
    return (
      ...
      >
        <div
          className={`bg-element border rounded-lg overflow-hidden transition-all duration-200 group cursor-pointer ${isActive
              ? "ring-2 ring-focus"
              : "border-base hover:border-focus"
            }`}
          onClick={onClick}
        >
          <div className="p-3">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center space-x-1">
                <button
                  ...
                  className={`p-1.5 rounded transition-colors ${item.isFavorite
  ...
  return (
    ...
    >
      <div
        className={`bg-element border rounded-lg transition-all duration-200 group flex items-start p-3 space-x-4 cursor-pointer ${isActive
            ? "ring-2 ring-focus"
            : "border-base hover:border-focus"
          }`}
        onClick={onClick}
