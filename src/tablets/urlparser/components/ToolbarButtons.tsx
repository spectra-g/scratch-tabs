    ...
    <div className="flex items-center space-x-2">
      <button
        ...
        className={`p-2 rounded-md ${
          showCurlPopup ? 'bg-blue-500/20 text-blue-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700'
        }`}
      ...
      <button
        ...
        className={`p-2 rounded-md ${
          isEncoded ? 'bg-purple-500/20 text-purple-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700'
        }`}
      ...
      <button
        ...
        className={`p-2 rounded-md ${
          showComparison ? 'bg-green-500/20 text-green-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700'
        }`}
        title={showComparison ? "Hide comparison view" : "Show cross-platform comparison"}
      >
      ...
      <button
        ...
        className={`p-2 rounded-md ${
          hasWarnings ? 'text-yellow-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-700'
        }`}
        ...
        <div className="absolute top-12 right-0 bg-gray-800 border border-gray-700 rounded-md shadow-lg p-3 z-10 w-96">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                {curlCopied ? <Check size={14} className="text-green-500" /> : <Copy size={14} />}
              </button>
              <button
