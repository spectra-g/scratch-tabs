      ...
      {settings.mode === 'custom' && (
        <div className="space-y-3">
          ...
          <textarea
            ...
            className="w-full h-24 px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none disabled:opacity-50"
          />
