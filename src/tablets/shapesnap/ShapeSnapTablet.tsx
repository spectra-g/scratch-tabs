  ...
  deserializeState(json: string): TabletState {
    try {
      ...
      if (parsed.type === "shapesnap" && parsed.data) {
        ...
        data.selectedShapeIds = Array.isArray(data.selectedShapeIds)
        ...
        data.historyIndex =
          typeof data.historyIndex === "number" ? data.historyIndex : -1;
        data.currentFontSize =
          typeof data.currentFontSize === "number" ? data.currentFontSize : 16;
