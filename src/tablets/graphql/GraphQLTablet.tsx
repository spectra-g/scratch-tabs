  ...
  return (
    <div className="h-full bg-canvas flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        <div
          className="border-r border-base overflow-hidden bg-surface-secondary flex flex-col"
        ...
        >
          <div className="flex-none flex items-center space-x-1 px-4 pt-3 border-b border-base bg-surface-secondary">
            <button
              onClick={() => updateState({ activeTab: "query" })}
              className={`px-4 py-2 text-sm rounded-t ${data.activeTab === "query"
                ? "bg-element-active text-main"
          ...
          <div className="flex-none p-3 border-t border-base bg-surface-secondary">
            {isSubscription ? (
