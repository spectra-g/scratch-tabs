  ...
  if (history.length === 0) {
    return (
      <div className="p-6 flex flex-col items-center justify-center h-64">
        ...
        <p className="text-sm text-gray-500">Tokens you decode or generate will appear here</p>
      </div>
    );
  }
          ...
          <div key={index} className="bg-gray-800/50 border border-gray-700/50 rounded-md p-3">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-mono text-gray-300 truncate" title={item.token}>
                  {item.token}
                </p>
