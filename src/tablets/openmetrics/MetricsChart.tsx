...
export const MetricsChart: React.FC<MetricsChartProps> = ({
  ...
  const chartData = useMemo(() => {
    ...
    return groupMetricsByLabels(
      selectedMetricSamples,
      chartConfig.groupByLabels,
    );
      ...
      <div className="p-3 border-b border-base">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
          <div className="mb-2 md:mb-0">
            <h3 className="text-sm font-medium text-secondary">Metric Chart</h3>
            {selectedMetricName && (
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className={`p-2 rounded ${chartConfig.type === "bar" ? "bg-primary/20 text-primary" : "text-muted hover:bg-surface-secondary"}`}
              title="Bar Chart"
            >
            ...
            <button
              ...
              className={`p-2 rounded ${chartConfig.type === "line" ? "bg-primary/20 text-primary" : "text-muted hover:bg-surface-secondary"}`}
              title="Line Chart"
            >
            ...
            <button
              ...
              className={`p-2 rounded ${chartConfig.type === "pie" ? "bg-primary/20 text-primary" : "text-muted hover:bg-surface-secondary"}`}
              title="Pie Chart"
            >
