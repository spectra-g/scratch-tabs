...
describe("ModalStore", () => {
  ...
  describe("Tab Management Modal", () => {
    ...
    it("should set action in progress state", () => {
      ...
      expect(useModalStore.getState().isTabManagementActionInProgress).toBe(
        true,
      );
  ...
  describe("Function References", () => {
    it("should provide consistent function references", () => {
      ...
      expect(store1.closeTabManagementModal).toBe(
        store2.closeTabManagementModal,
      );
      expect(store1.setTabManagementActionInProgress).toBe(
        store2.setTabManagementActionInProgress,
      );
