 ...
 */
export function updateTabHistory(history: string[] | undefined | null, tabId: string): string[] {
  if (!history) {
    return [tabId];
  }
  return [
 ...
 */
export function getPreviousActiveTab(history: string[] | undefined | null, currentTabs: string[]): string | null {
 ...
 */
export function removeTabFromHistory(history: string[] | undefined | null, tabId: string): string[] {
  if (!history) {
    return [];
  }
