...
function generateDocstring(className: string, properties: { name: string; type: string }[]): string {
  return `"""
${className} class.
...
export function generatePythonClasses(json: any, rootClassName: string = 'Root'): PythonClass[] {
