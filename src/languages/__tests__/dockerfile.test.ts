import { DockerfileLanguageDetector } from "../dockerfile";

describe("DockerfileLanguageDetector", () => {
  let detector: DockerfileLanguageDetector;

  beforeEach(() => {
    detector = new DockerfileLanguageDetector();
  });
