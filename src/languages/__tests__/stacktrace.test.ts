import { StacktraceLanguageDetector } from "../stacktrace";

describe("StacktraceLanguageDetector", () => {
  let detector: StacktraceLanguageDetector;

  beforeEach(() => {
    detector = new StacktraceLanguageDetector();
  });
