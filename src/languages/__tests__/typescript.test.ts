import { TypeScriptLanguageDetector } from "../javascript";

describe("TypeScriptLanguageDetector", () => {
  let detector: TypeScriptLanguageDetector;

  beforeEach(() => {
    detector = new TypeScriptLanguageDetector();
  });
