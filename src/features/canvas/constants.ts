...
export const DEFAULT_LINK_ITEM_WIDTH = 360;
export const DEFAULT_LINK_ITEM_HEIGHT = 180;
export const MIN_LINK_ITEM_WIDTH = 240;
export const MIN_LINK_ITEM_HEIGHT = 140;
export const DEFAULT_VIDEO_ITEM_WIDTH = 480;
export const DEFAULT_VIDEO_ITEM_HEIGHT = 300;
export const MIN_VIDEO_ITEM_WIDTH = 320;
export const MIN_VIDEO_ITEM_HEIGHT = 260;
...
export const CANVAS_INGEST_GAP = 32;
export const CANVAS_INGEST_VIEWPORT_PADDING = 24;
