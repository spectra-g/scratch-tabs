...
const JsonTreeViewModal: React.FC<JsonTreeViewModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-themed-secondary rounded-lg shadow-xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden border border-themed/50">
        <div className="flex-none flex items-center justify-between p-3 border-b border-themed/50">
          <h2 className="text-lg font-medium text-gray-100">JSON Tree View</h2>
          <button
            onClick={onClose}
            className="p-1 text-themed-tertiary hover:text-gray-100 hover:bg-themed-tertiary/50 rounded-full transition-colors"
