...
import { XmlSmartView } from "./views/XmlSmartView";
...
export class XmlFormatModule extends XmlFormatDetector {
...
const xmlDetector = new XmlFormatModule();
formatRegistry.register(xmlDetector);

xmlDetector.getSmartViews().forEach((view) => {
