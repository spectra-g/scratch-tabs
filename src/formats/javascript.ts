...
console.log(MyMath.circumference(10));
  ...
  detect(content: string): DetectionResult {
    ...
    const jsDetector = formatRegistry.getById("javascript") as
...
const jsDetector = new JavaScriptFormatDetector();
const tsDetector = new TypeScriptFormatDetector();
formatRegistry.register(jsDetector);
formatRegistry.register(tsDetector);
