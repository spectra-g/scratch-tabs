...
export type MappingDirection =
  (typeof MAPPING_DIRECTION)[keyof typeof MAPPING_DIRECTION];
export type VaultSortOrder =
  (typeof VAULT_SORT_ORDER)[keyof typeof VAULT_SORT_ORDER];
...
export type ContextMenuAction =
  (typeof CONTEXT_MENU_ACTIONS)[keyof typeof CONTEXT_MENU_ACTIONS];
