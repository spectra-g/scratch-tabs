  ...
  <div className="p-3 border-b border-themed bg-themed-secondary">
    <div className="flex flex-wrap gap-3">
      ...
      <div className="relative flex-grow max-w-md">
        ...
        <Search
          size={16}
          className="absolute left-3 top-1/2 transform -translate-y-1/2 text-themed-muted"
        />
      </div>
      ...
      <div className="relative">
        ...
        <Filter
          size={14}
          className="absolute right-2.5 top-1/2 transform -translate-y-1/2 text-themed-muted pointer-events-none"
        />
      </div>
        ...
        {selectedTabIds.size > 0 && (
          <div className="flex items-center space-x-1">
            <button
              ...
              className="px-2 py-0.5 text-xs text-themed-muted hover:text-themed-secondary"
            >
              Deselect All
            </button>
          </div>
        ...
        activeWorkspaceTabs.some(
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="flex items-center space-x-1 px-2 py-1 text-xs bg-themed-secondary hover:bg-themed-hover rounded-md transition-colors"
              title="Toggle pin status for selected"
            >
              <Pin size={14} className="text-themed-muted" />
            ...
            >
              <Copy size={14} className="text-themed-muted" />
              <span>Duplicate</span>
            </button>
            ...
            {selectedTabIds.size >= 2 && (
              <div className="relative">
                ...
                >
                  <Edit size={14} className="text-themed-muted" />
                  <span>Rename</span>
                </button>

                {showRenameOptions && (
                  <div className="absolute right-0 top-full mt-1 bg-themed border border-themed rounded-md shadow-lg z-10 p-3 w-64">
                    <div className="text-xs text-themed-secondary mb-2">Base Name</div>
                    <input
                      type="text"
                    ...
                    <div className="flex justify-end space-x-2">
                      <button
                        ...
                        className="px-2 py-1 text-xs text-themed-muted hover:text-themed-secondary"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="px-2 py-1 text-xs bg-blue-500/10 text-blue-500 rounded hover:bg-blue-500/20 disabled:opacity-50"
                      >
                        Rename
                      </button>
                    </div>
            ...
            {selectedTabIds.size >= 2 && (
              <div className="relative">
                ...
                >
                  <Merge size={14} className="text-themed-muted" />
                  <span>Merge</span>
                </button>
                ...
                {showMergeOptions && (
                  <div className="absolute right-0 top-full mt-1 bg-themed border border-themed rounded-md shadow-lg z-10 p-3 w-64">
                    ...
                    <select
                      ...
                      className="w-full bg-themed-secondary border border-themed rounded px-2 py-1 text-sm text-themed mb-3"
                    >
...
export const WorkspaceForm: React.FC<WorkspaceFormProps> = ({
  ...
  <div className="mt-3 p-3 bg-themed-secondary rounded-md">
    <input
      type="text"
      value={workspaceName}
...
export const TabsContent: React.FC<TabsContentProps> = ({
  ...
  <div className="flex-1 overflow-y-auto custom-scrollbar">
    ...
    {emptyTabs.length > 1 && (
      <div className="m-3 p-3 bg-blue-500/10 border border-blue-500/30 rounded-md flex items-center justify-between">
        ...
        <button
          ...
          className="px-2 py-1 text-xs bg-blue-500/10 text-blue-500 rounded hover:bg-blue-500/20 transition-colors"
        >
          Remove All
        </button>
      </div>
    ...
    {filteredTabs.length === 0 ? (
      <div className="flex flex-col items-center justify-center h-full text-themed-muted">
    ...
    {activeDragId && activeDragItemData && (
      <div className="pointer-events-none">
        {draggedTabIds.size === 1 ? (
          ...
          <div className="bg-themed text-themed text-xs px-3 py-1.5 rounded-md shadow-lg border border-themed inline-block">
