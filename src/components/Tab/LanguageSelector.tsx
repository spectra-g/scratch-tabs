...
export const LanguageSelector: React.FC<LanguageSelectorProps> = ({ onSelect }) => {
    ...
    const sortedLanguages = allLanguages.sort((a: LanguageDetector, b: LanguageDetector) => {
    ...
    const otherLangs = sortedLanguages.filter(lang => lang.id !== 'json' && lang.id !== 'markdown');
