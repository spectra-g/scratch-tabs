...
export const SearchPreviewPane: React.FC<SearchPreviewPaneProps> = ({ tab, selectedResult }) => {
    ...
    useEffect(() => {
        ...
        const displayLanguage = selectedResult?.language ?? tab?.language ?? 'plaintext';
        ...
        if (selectedResult) {
            ...
            revealTimeoutRef.current = setTimeout(() => {
                ...
                if (currentModel && lineNumber > 0 && lineNumber <= currentModel.getLineCount()) {
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                options: {
                                    ...
                                    stickiness: currentMonaco.editor.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges
                                }
                            }
                        ]
                    );
